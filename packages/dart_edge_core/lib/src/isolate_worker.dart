...
typedef DartEdgeIsolateRequestHandler = FutureOr<Object?> Function(Object? request);
...
final class DartEdgeIsolateWorkerPool {
  ...
  static Future<DartEdgeIsolateWorkerPool> spawn({
    ...
    DartEdgeIsolateWorkerPoolStrategy strategy = DartEdgeIsolateWorkerPoolStrategy.leastPending,
  ...
  DartEdgeIsolateWorker _selectWorker() {
    return switch (strategy) {
      DartEdgeIsolateWorkerPoolStrategy.roundRobin => _workers[_nextWorker++ % _workers.length],

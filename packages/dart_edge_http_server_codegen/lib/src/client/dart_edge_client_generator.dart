...
final class DartEdgeClientLibrarySpec {
  ...
  factory DartEdgeClientLibrarySpec.fromRouter({
    ...
    DartEdgeClientGenerationOptions options = const DartEdgeClientGenerationOptions(),
  }) {
...
final class DartEdgeClientGenerator {
  ...
  String generate(
    DartEdgeClientLibrarySpec spec, {
    DartEdgeClientFormatterOptions formatterOptions = const DartEdgeClientFormatterOptions(),
  }) {
    final library = Library((builder) {
      builder
        ..comments.add('GENERATED CODE - DO NOT MODIFY BY HAND.')
        ..directives.add(Directive.import('package:dart_edge_core/dart_edge_core.dart'))
...
''');
  ...
  Class _webTransportOperationClass(DartEdgeClientWebTransportOperation operation) {
    return Class((builder) {
      builder
        ..modifier = ClassModifier.final$
        ..name = _operationClassName(operation.resolvedMethodName)
  ...
  Method _webSocketOperationGetter(DartEdgeClientWebSocketOperation operation) =>
      _operationGetter(operation.resolvedMethodName);

  Method _webTransportOperationGetter(DartEdgeClientWebTransportOperation operation) =>
      _operationGetter(operation.resolvedMethodName);
  ...
  Method _operationMethod(DartEdgeClientOperation operation, {required String name}) {
    return Method((builder) {
      builder
...
'''),
  ...
  Method _binaryStreamOperationMethod(DartEdgeClientOperation operation, {required String name}) {
    return Method((builder) {
      builder
        ..returns = _type('Future', [refer('DartEdgeClientStreamedResponseObject')])
        ..name = name
        ..optionalParameters.addAll(_operationParameters(operation))
  ...
  Iterable<Parameter> _operationParameters(DartEdgeClientOperation operation) {
    return <Parameter>[
      ...
      if (_isMultipartOperation(operation))
        _namedParameter(
          'onUploadProgress',
          type: refer('void Function(DartEdgeMultipartUploadProgress progress)?'),
        ),
    ];
  }
  ...
  Expression _invokeExpression(DartEdgeClientOperation operation) {
    ...
    final invocation = refer('DartEdgeClientInvocation')
  ...
  Method _webSocketMethod(DartEdgeClientWebSocketOperation operation, {required String name}) {
    ...
    return Method((builder) {
      builder
        ...
        ..body = refer('_client')
            ...
            .call(
              [
                refer('DartEdgeClientWebSocketInvocation').newInstance(const <Expression>[], {
  ...
  Iterable<Parameter> _webSocketParameters(DartEdgeClientWebSocketOperation operation) {
    return <Parameter>[
      if (operation.paramsType case final type?)
        _namedParameter('params', type: refer(type), required: true),
      if (operation.queryType case final type?) _namedParameter('query', type: refer('$type?')),
  ...
  List<Reference> _webSocketInvocationTypes(DartEdgeClientWebSocketOperation operation) {
    return <Reference>[
  ...
  Method _webTransportMethod(
    ...
    return Method((builder) {
      builder
        ..returns = _type('Future', [refer('DartEdgeClientWebTransportSession')])
        ..name = name
        ...
        ..body = refer('_client')
            ...
            .call(
              [
                refer('DartEdgeClientWebTransportInvocation').newInstance(const <Expression>[], {
                  'pathTemplate': literalString(operation.path),
                  if (operation.paramsType != null)
                    'params': _requestValueExpression(
                      type: operation.paramsType!,
  ...
  Iterable<Parameter> _webTransportParameters(DartEdgeClientWebTransportOperation operation) {
    return <Parameter>[
      if (operation.paramsType case final type?)
        _namedParameter('params', type: refer(type), required: true),
      if (operation.queryType case final type?) _namedParameter('query', type: refer('$type?')),
  ...
  List<Reference> _webTransportInvocationTypes(DartEdgeClientWebTransportOperation operation) {
    return <Reference>[
      refer(operation.paramsType ?? 'Never'),
      refer(operation.queryType == null ? 'Never' : '${operation.queryType}?'),
      refer(operation.headersType == null ? 'Never' : '${operation.headersType}?'),
  ...
  Map<String, Expression> _invocationArguments(DartEdgeClientOperation operation) {
      ...
      if (options.responses.errors.isNotEmpty)
        'errors': literalList([
          for (final error in options.responses.errors)
            refer('DartEdgeClientErrorSpec').newInstance(const <Expression>[], <String, Expression>{
...
String _format(Library library, {required DartEdgeClientFormatterOptions formatterOptions}) {

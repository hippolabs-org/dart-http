//! Shared native HTTP handler ABI types for Dart HTTP native crates.

#![deny(missing_docs)]

use std::ffi::c_char;

pub use dart_http_core::{NativeBytes, NativePair};
...
/// Native HTTP method code shared across Dart HTTP native crates.
#[repr(i32)]

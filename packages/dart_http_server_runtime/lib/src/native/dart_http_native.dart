...
abstract final class DartHttpNative {
  /// ABI version exposed by the bundled native runtime.
  static int get abiVersion => gen.dart_http_server_runtime_native_abi_version();
  ...
  static NativeServerStartResult startServer(
    ...
    try {
      final result = gen.dart_http_server_runtime_start_server(
        hostPtr.cast<Char>(),
        port,
        workers,
      ...
      return NativeServerStartResult(serverId: result >> 16, port: result & 0xffff);
    } finally {
      calloc.free(hostPtr);
  ...
  static bool tryRespond(
    ...
    try {
      ...
      return _withNativeHeaders(
        headers,
        (headerStorage, headerCount) => gen.dart_http_server_runtime_send_response(
          requestId,
          status,
  ...
  static bool acceptWebSocket(int requestId, {List<HttpHeader> headers = const <HttpHeader>[]}) {
    return _withNativeHeaders(
      headers,
      (headerStorage, headerCount) =>
          gen.dart_http_server_runtime_accept_web_socket(requestId, headerCount, headerStorage),
    );
  }

  /// Accepts a pending WebTransport CONNECT request.
  static bool acceptWebTransport(int requestId, {List<HttpHeader> headers = const <HttpHeader>[]}) {
    return _withNativeHeaders(
      headers,
      (headerStorage, headerCount) =>
          gen.dart_http_server_runtime_accept_web_transport(requestId, headerCount, headerStorage),
    );
  }
  ...
  static bool startSseResponse(
    ...
    return _withNativeHeaders(
      headers,
      (headerStorage, headerCount) => gen.dart_http_server_runtime_start_sse_response(
        requestId,
        status,
        headerCount,
        headerStorage,
  ...
  static bool sendSseChunk(int requestId, String chunk) {
    ...
    try {
      return gen.dart_http_server_runtime_send_sse_chunk(requestId, chunkPtr.cast<Char>());
    } finally {
  ...
  static bool finishSseResponse(int requestId) {
    return gen.dart_http_server_runtime_finish_sse_response(requestId);
  }
  ...
  static bool startBinaryStreamResponse(
    ...
    try {
      return _withNativeHeaders(
        headers,
        (headerStorage, headerCount) => gen.dart_http_server_runtime_start_binary_stream_response(
          requestId,
          status,
          contentTypePtr.cast<Char>(),
          contentLength ?? -1,
  ...
  static bool finishBinaryStreamResponse(int requestId) {
    return gen.dart_http_server_runtime_finish_binary_stream_response(requestId);
  }
  ...
  static NativeWebSocketConnection? takeWebSocketConnection(int sessionId) {
    final connectionPtr = gen.dart_http_server_runtime_take_web_socket_connection(sessionId);
    ...
    try {
      ...
      gen.dart_http_server_runtime_free_web_socket_connection(connectionPtr);
    }
  }
  ...
  static NativeWebSocketMessage? takeWebSocketMessage(int sessionId) {
    final messagePtr = gen.dart_http_server_runtime_take_web_socket_message(sessionId);
    ...
    try {
      ...
      if (!transferred) {
        gen.dart_http_server_runtime_free_web_socket_message(messagePtr);
      }
    }
  }
  ...
  static NativeWebTransportConnection? takeWebTransportConnection(int sessionId) {
    ...
    try {
      ...
      gen.dart_http_server_runtime_free_web_transport_connection(connectionPtr);
    }
  }
  ...
  static NativeWebTransportDatagram? takeWebTransportDatagram(int sessionId) {
    final datagramPtr = gen.dart_http_server_runtime_take_web_transport_datagram(sessionId);
    ...
    try {
      return decodeNativeWebTransportDatagram(
        datagramPtr,
        release: () => gen.dart_http_server_runtime_free_web_transport_datagram(datagramPtr),
      );
    } catch (_) {
      gen.dart_http_server_runtime_free_web_transport_datagram(datagramPtr);
      rethrow;
    }
  }
  ...
  static NativeWebTransportStream? takeWebTransportStream(int sessionId) {
    final streamPtr = gen.dart_http_server_runtime_take_web_transport_stream(sessionId);
    ...
    try {
      return decodeNativeWebTransportStream(
        streamPtr,
        release: () => gen.dart_http_server_runtime_free_web_transport_stream(streamPtr),
      );
    } catch (_) {
      gen.dart_http_server_runtime_free_web_transport_stream(streamPtr);
      rethrow;
    }
  }

  static NativeWebTransportStreamInfo? takeWebTransportStreamInfo(int streamId) {
    final infoPtr = gen.dart_http_server_runtime_take_web_transport_stream_info(streamId);
    if (infoPtr == nullptr) return null;
    try {
      return decodeNativeWebTransportStreamInfo(infoPtr);
    } finally {
      gen.dart_http_server_runtime_free_web_transport_stream_info(infoPtr);
    }
  }
  ...
  static NativeWebTransportStreamChunk? takeWebTransportStreamChunk(int streamId) {
    ...
    try {
      return decodeNativeWebTransportStreamChunk(
        chunkPtr,
        release: () => gen.dart_http_server_runtime_free_web_transport_stream_chunk(chunkPtr),
      );
    } catch (_) {
      gen.dart_http_server_runtime_free_web_transport_stream_chunk(chunkPtr);
      rethrow;
    }
  }

  static NativeWebTransportStreamTerminal? takeWebTransportStreamTerminal(int streamId) {
    final terminalPtr = gen.dart_http_server_runtime_take_web_transport_stream_terminal(streamId);
    if (terminalPtr == nullptr) return null;
    try {
      return decodeNativeWebTransportStreamTerminal(terminalPtr);
    } finally {
      gen.dart_http_server_runtime_free_web_transport_stream_terminal(terminalPtr);
    }
  }

  static NativeWebTransportOperation? takeWebTransportOperation(int operationId) {
    final operationPtr = gen.dart_http_server_runtime_take_web_transport_operation(operationId);
    if (operationPtr == nullptr) return null;
    try {
      return decodeNativeWebTransportOperation(operationPtr);
    } finally {
      gen.dart_http_server_runtime_free_web_transport_operation(operationPtr);
    }
  }
  ...
  static bool webSocketSendBinary(int sessionId, List<int> body) {
    ...
    try {
      ...
      nativeBytesPtr.ref
        ..ptr = bodyPtr
        ..len = bytes.length;
      return gen.dart_http_server_runtime_web_socket_send_binary(sessionId, nativeBytesPtr.ref);
    } finally {
      calloc.free(nativeBytesPtr);
      calloc.free(bodyPtr);
    }
  ...
  static bool webSocketSendNativeBinary(
    ...
    return _withBorrowedNativeBody(
      ...
      run: (body) => gen.dart_http_server_runtime_web_socket_send_binary(sessionId, body),
    );
  }
  ...
  static bool webSocketClose(int sessionId, {int? code, String? reason}) {
    ...
    try {
      return gen.dart_http_server_runtime_web_socket_close(
        sessionId,
        code ?? 0,
  ...
  static bool webTransportSendDatagram(int sessionId, List<int> body) {
    return _withNativeBody(
      body,
      (nativeBytes) =>
          gen.dart_http_server_runtime_web_transport_send_datagram(sessionId, nativeBytes),
    );
  }
  ...
  static bool webTransportSendNativeDatagram(
    ...
    return _withBorrowedNativeBody(
      bodyPtr: bodyPtr,
      bodyLength: bodyLength,
      run: (body) => gen.dart_http_server_runtime_web_transport_send_datagram(sessionId, body),
    );
  }
  ...
  static bool webTransportSendStream(int sessionId, List<int> body) {
    return _withNativeBody(
      body,
      (nativeBytes) =>
          gen.dart_http_server_runtime_web_transport_send_stream(sessionId, nativeBytes),
    );
  }
  ...
  static bool webTransportSendNativeStream(
    ...
    return _withBorrowedNativeBody(
      bodyPtr: bodyPtr,
      bodyLength: bodyLength,
      run: (body) => gen.dart_http_server_runtime_web_transport_send_stream(sessionId, body),
    );
  }

  static int webTransportOpenUnidirectionalStream(int sessionId) =>
      gen.dart_http_server_runtime_web_transport_open_unidirectional_stream(sessionId);

  static int webTransportOpenBidirectionalStream(int sessionId) =>
      gen.dart_http_server_runtime_web_transport_open_bidirectional_stream(sessionId);

  static int webTransportStreamWrite(int streamId, List<int> body) => _withNativeBody(
    body,
    (nativeBytes) => gen.dart_http_server_runtime_web_transport_stream_write(streamId, nativeBytes),
  );
  ...
  static int webTransportStreamWriteNative(
    ...
    bodyPtr: bodyPtr,
    bodyLength: bodyLength,
    run: (body) => gen.dart_http_server_runtime_web_transport_stream_write(streamId, body),
  );

  static int webTransportStreamFinish(int streamId) =>
      gen.dart_http_server_runtime_web_transport_stream_finish(streamId);
  ...
  static int webTransportStreamReset(int streamId, int errorCode) {
    ...
    return gen.dart_http_server_runtime_web_transport_stream_reset(streamId, errorCode);
  }

  static int webTransportStreamStop(int streamId, int errorCode) {
    RangeError.checkValueInInterval(errorCode, 0, 0xffffffff, 'errorCode');
    return gen.dart_http_server_runtime_web_transport_stream_stop(streamId, errorCode);
  }
  ...
  static bool webTransportClose(int sessionId, {int? code, String? reason}) {
    final reasonPtr = reason?.toNativeUtf8();
    try {
      return gen.dart_http_server_runtime_web_transport_close(
        sessionId,
        code ?? 0,
        reasonPtr?.cast<Char>() ?? nullptr,
      );
...
T _withNativeHeaders<T>(
  ...
  try {
    ...
    return run(nativeHeaders.isEmpty ? nullptr : headerStorage, nativeHeaders.length);
  } finally {

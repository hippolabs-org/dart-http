...
@ffi.DefaultAsset('package:dart_http_server_runtime/dart_http_server_runtime.dart')
library;
...
@ffi.Native<ffi.Bool Function(ffi.Int64, ffi.IntPtr, ffi.Pointer<NativePair>)>()
external bool dart_http_server_runtime_accept_web_transport(
  int request_id,
  int header_count,
  ffi.Pointer<NativePair> headers,
);
...
@ffi.Native<ffi.Bool Function(ffi.Int64)>()
external bool dart_http_server_runtime_finish_sse_response(int request_id);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeMultipartForm>)>(isLeaf: true)
external void dart_http_server_runtime_free_multipart_form(ffi.Pointer<NativeMultipartForm> value);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeTransportRequest>)>(isLeaf: true)
external void dart_http_server_runtime_free_request(ffi.Pointer<NativeTransportRequest> value);

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Char>)>(isLeaf: true)
external void dart_http_server_runtime_free_string(ffi.Pointer<ffi.Char> value);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebSocketConnection>)>(isLeaf: true)
external void dart_http_server_runtime_free_web_socket_connection(
  ffi.Pointer<NativeWebSocketConnection> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebSocketMessage>)>(isLeaf: true)
external void dart_http_server_runtime_free_web_socket_message(
  ffi.Pointer<NativeWebSocketMessage> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportConnection>)>()
external void dart_http_server_runtime_free_web_transport_connection(
  ffi.Pointer<NativeWebTransportConnection> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportDatagram>)>()
external void dart_http_server_runtime_free_web_transport_datagram(
  ffi.Pointer<NativeWebTransportDatagram> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportOperation>)>()
external void dart_http_server_runtime_free_web_transport_operation(
  ffi.Pointer<NativeWebTransportOperation> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportStream>)>()
external void dart_http_server_runtime_free_web_transport_stream(
  ffi.Pointer<NativeWebTransportStream> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportStreamChunk>)>()
external void dart_http_server_runtime_free_web_transport_stream_chunk(
  ffi.Pointer<NativeWebTransportStreamChunk> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportStreamInfo>)>()
external void dart_http_server_runtime_free_web_transport_stream_info(
  ffi.Pointer<NativeWebTransportStreamInfo> value,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<NativeWebTransportStreamTerminal>)>()
external void dart_http_server_runtime_free_web_transport_stream_terminal(
  ffi.Pointer<NativeWebTransportStreamTerminal> value,
);

@ffi.Native<ffi.Int32 Function()>(isLeaf: true)
external int dart_http_server_runtime_native_abi_version();
...
>()
external ffi.Pointer<NativeMultipartForm> dart_http_server_runtime_parse_multipart(
...
>()
external bool dart_http_server_runtime_send_response(
  int request_id,
  int status,
  ffi.Pointer<ffi.Char> content_type,
  NativeBytes body,
...
>()
external bool dart_http_server_runtime_start_binary_stream_response(
  int request_id,
  int status,
  ffi.Pointer<ffi.Char> content_type,
  int content_length,
...
>()
external int dart_http_server_runtime_start_server(
...
@ffi.Native<ffi.Bool Function(ffi.Int64, ffi.Int32, ffi.IntPtr, ffi.Pointer<NativePair>)>()
external bool dart_http_server_runtime_start_sse_response(
  int request_id,
  int status,
  int header_count,
  ffi.Pointer<NativePair> headers,
...
external void dart_http_server_runtime_stop_server();

@ffi.Native<ffi.Void Function(ffi.Int64)>()
external void dart_http_server_runtime_stop_server_by_id(int server_id);

@ffi.Native<ffi.Pointer<ffi.Char> Function()>()
external ffi.Pointer<ffi.Char> dart_http_server_runtime_take_last_error();
...
dart_http_server_runtime_take_web_transport_stream_chunk(int stream_id);

@ffi.Native<ffi.Pointer<NativeWebTransportStreamInfo> Function(ffi.Int64)>()
external ffi.Pointer<NativeWebTransportStreamInfo>
dart_http_server_runtime_take_web_transport_stream_info(int stream_id);
...
dart_http_server_runtime_take_web_transport_stream_terminal(int stream_id);

@ffi.Native<ffi.Bool Function(ffi.Int64, ffi.Int32, ffi.Pointer<ffi.Char>)>()
external bool dart_http_server_runtime_web_socket_close(
  int session_id,
  int code,
...
@ffi.Native<ffi.Bool Function(ffi.Int64, ffi.Int32, ffi.Pointer<ffi.Char>)>()
external bool dart_http_server_runtime_web_transport_close(
  int session_id,
  int code,
  ffi.Pointer<ffi.Char> reason,
);
...
external int dart_http_server_runtime_web_transport_open_bidirectional_stream(int session_id);

@ffi.Native<ffi.Int64 Function(ffi.Int64)>()
external int dart_http_server_runtime_web_transport_open_unidirectional_stream(int session_id);

@ffi.Native<ffi.Bool Function(ffi.Int64, NativeBytes)>()
external bool dart_http_server_runtime_web_transport_send_datagram(
  int session_id,
  NativeBytes body,
);

@ffi.Native<ffi.Bool Function(ffi.Int64, NativeBytes)>()
external bool dart_http_server_runtime_web_transport_send_stream(int session_id, NativeBytes body);
...
@ffi.Native<ffi.Int64 Function(ffi.Int64, ffi.Uint32)>()
external int dart_http_server_runtime_web_transport_stream_stop(int stream_id, int error_code);
...
final class NativeMultipartField extends ffi.Struct {
  external NativeBytes name;

  external NativeBytes value;
}

final class NativeMultipartFile extends ffi.Struct {
  external NativeBytes field_name;

  external NativeBytes filename;
...
typedef dart_http_server_runtime_transport_event_callback_t =
    ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int32 event_kind, ffi.Int64 event_id)>>;
